...
import { calculateFactoryOverall } from '../utils';
        ...
        <div className="rounded-3xl bg-gradient-to-b from-[#0e2f38] via-[#0a232a] to-[#06161b] text-white border border-[#1b434b] p-5 sm:p-7 shadow-xl relative overflow-hidden space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-white/10 pb-5 relative z-10">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-[10px] font-bold text-emerald-300 uppercase tracking-wider">
              ...
              <div className="flex items-baseline gap-3">
                <span
                  ...
                  className="font-mono-numbers text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-none drop-shadow-xs"
                >
                  {formattedLiveTime}
                </span>
              ...
              <div className="flex items-center gap-3 pt-1 max-w-md">
                ...
                <span className="text-[11px] font-bold font-mono-numbers text-sky-200/90 whitespace-nowrap">
            ...
            <div className="flex items-center gap-2.5 flex-wrap self-start lg:self-center">
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border border-white/20 bg-white/10 hover:bg-white/15 text-white font-bold text-xs transition-all shadow-xs cursor-pointer"
              >
                <span
                ...
                <span>
                  Role: <strong className="font-mono text-teal-300">{currentTier.systemRole}</strong> ({currentTier.name})
                </span>
              </button>

              {/* Telemetry Auto-Update Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/10 border border-white/15 text-xs text-sky-100">
                <span className="text-[11px] text-sky-200 font-mono-numbers">
                  Sync: {syncTime}
                </span>
                <button
                ...
                >
                  <RotateCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-teal-300' : ''}`} />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              {/* 3 Executive Metrics Banners */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                {/* 1. Factory Efficiency */}
                <div className="p-3.5 rounded-2xl bg-white/10 border border-white/15 space-y-1">
                  <div className="flex items-center justify-between text-[11px] text-sky-200 font-bold uppercase">
                    <span>Plant Efficiency</span>
                    <TrendingUp className="w-3.5 h-3.5 text-teal-300" />
                  </div>
                  <div className="text-2xl sm:text-3xl font-black font-mono-numbers text-white">
                ...
                <div className="p-3.5 rounded-2xl bg-white/10 border border-white/15 space-y-1">
                  ...
                  <span className="text-[10px] text-sky-200 font-mono-numbers block">
              ...
              <div className="p-3 rounded-2xl bg-white/5 border border-white/10 flex flex-wrap items-center justify-between gap-2 text-xs text-sky-100">
                <div className="flex items-center gap-2">
                  ...
                  <span><strong>{factory.activeLinesCount} Sewing Lines</strong> Active ({lines.map(l => `L${l.lineNo}`).join(', ')})</span>
                </div>
          ...
          <div className="pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-2.5 text-xs relative z-10">
            <div className="flex items-center gap-2 flex-wrap">
              <button
                type="button"
                onClick={() => setIsHuddleOpen(true)}
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white/15 hover:bg-white/25 text-white font-bold transition-colors cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={() => onNavigate('checklist')}
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold transition-colors cursor-pointer"
              >
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>Daily Checklist ({checklistCounts.done}/{checklistCounts.total})</span>
              </button>
              ...
              >
                ...
                <span>All Summarized Reports</span>
              </button>
              ...
              {onOpenScorecard && (
                ...
                >
                  ...
                  <span>IE Performance Scorecard</span>
                </button>
              )}
            </div>
